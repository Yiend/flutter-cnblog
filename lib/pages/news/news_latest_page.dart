...
class NewsLatestPage extends StatefulWidget {
  @override
  _NewsLatestState createState() => _NewsLatestState();
}

class _NewsLatestState extends State<NewsLatestPage> {
  ...
  Future<List<NewsModel>> fakeRequest() async {
    var modules = await newsService.getLatestNews(this.page, 10);
  ...
  */
  Future<void> _onRefresh() async {
    var modules = await newsService.getLatestNews(1, 10);
 ...
 */
  ...
  */
  Future<void> getFirstData() async {
    var modules = await newsService.getLatestNews(page, 10);
    setState(() {
      this.modules = modules;
      page++;
    });
