...
bool isNewsLatestInit = true;

class NewsLatestPage extends StatelessWidget {
  const NewsLatestPage({Key key, this.labId}) : super(key: key);
  final String labId;
  ...
  Widget build(BuildContext context) {
    ...
    return new StreamBuilder(
        stream: newsbloc.latestNewsStream,
        builder:
