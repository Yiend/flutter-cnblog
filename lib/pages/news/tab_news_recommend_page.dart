...
bool isNewsRecommendInit = true;

class NewsRecommendPage extends StatelessWidget {
  const NewsRecommendPage({Key key, this.labId}) : super(key: key);
  final String labId;
  ...
  Widget build(BuildContext context) {
    ...
    if (isNewsRecommendInit) {
      isNewsRecommendInit = false;
    ...
    return new StreamBuilder(
        stream: newsbloc.recommendNewsStream,
        builder:
