...
class NewsRecommendPage extends StatefulWidget {
  @override
  _NewsRecommendState createState() => _NewsRecommendState();
}

class _NewsRecommendState extends State<NewsRecommendPage> {
  ...
  Future<List<NewsModel>> fakeRequest() async {
    var modules = await newsService.getRecommendNews(this.page, 10);
  ...
  */
  Future<void> _onRefresh() async {
    var modules = await newsService.getRecommendNews(1, 10);
 ...
 */
  ...
  */
  Future<void> getFirstData() async {
    var modules = await newsService.getRecommendNews(page, 10);
    setState(() {
      this.modules = modules;
      page++;
    });
