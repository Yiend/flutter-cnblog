...
class StatusesItem extends StatelessWidget {
  StatusesItem({Key key, this.labId, this.statusesModel}) : super(key: key);
  ...
  JavascriptChannel _updateCommentsJavascriptChannel(BuildContext context) {
    return JavascriptChannel(
        ...
        onMessageReceived: (JavascriptMessage message) {
          ...
          statusesBloc.getStatusesComments(statusesModel.id);
    ...
    return new InkWell(
        onTap: () {
          NavigatorUtil.pushWebView(
            context,
            title: statusesModel.contentDisplay,
            labId: labId,
            url: Constant.statuseUrl,
            onPageFinished: (controller) {
              _controller = controller;
              controller.evaluateJavascript(
                  "updateModel(" + json.encode(statusesModel.toJson()) + ");");
            },
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                    ...
                    children: <Widget>[
                      ClipOval(
                        child: CachedNetworkImage(
                          ...
                          width: 40,
                          height: 40,
                          imageUrl: statusesModel.userIconUrl,
                  ...
                  Text(
                    statusesModel.contentDisplay == null
                        ? ""
                        : statusesModel.contentDisplay, //标题
                    style: TextStyle(
                      fontSize: 18.0,
                      color: Colors.black,
                      ...
                      Expanded(
                          ...
                          child: Row(
                            children: <Widget>[
                              infoItem(
                                  Icons.comment,
                                  this.statusesModel.commentCount.toString(),
                                  "回复"), //回复数,
                              infoItem(
