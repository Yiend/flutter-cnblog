...
class _WebViewExampleState extends State<WebViewExample> {
  ...
  void _writeDataFile() async {
    String dir = (await getApplicationDocumentsDirectory()).path;
    var url = "$dir/articles.html";
    //File file = new File('assets/articles.html');
    setState(() {
      _webUrl = url;
      print('AppPath ==== $_webUrl');
    });
  }
    ...
    return Scaffold(
      ...
      body: Builder(builder: (BuildContext context) {
        ...
        /* return WebView(
          ...
          initialUrl: "file:///android_assets/articles.html",
